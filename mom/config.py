...
class GPT2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        depth_per_chunk = None,
        router_type = 'naive',
        router_dim = 256,
        router_softmax_temperature = 1,
        enable_pause = True,
        require_anchor_layer = True,
        depthwise_bal_loss = False, 
        weighted_qkv = False,
        ...
        **kwargs,
        ...
        self.num_bottom_layers = num_bottom_layers
        self.depth_multiplier = depth_multiplier
        self.num_attn = num_attn
        self.num_ffn = num_ffn
        self.bind_ffn_attn = bind_ffn_attn
        self.use_ste = use_ste
        self.output_router_logits = output_router_logits
        self.router_aux_loss_coef = router_aux_loss_coef
        self.depth_per_chunk = depth_per_chunk
        self.router_type = router_type
        self.router_dim = router_dim
        self.router_softmax_temperature = router_softmax_temperature
        self.enable_pause = enable_pause
        self.require_anchor_layer = require_anchor_layer
        self.depthwise_bal_loss = depthwise_bal_loss
        self.weighted_qkv = weighted_qkv
        self.routing_all_possible_path = routing_all_possible_path
